    ...
    <div className="space-y-6 max-w-[1400px] mx-auto pb-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link href="/documents">
            <Button variant="ghost" size="icon" className="h-10 w-10 hover:bg-primary/10 hover:text-primary rounded-full border">
              <ArrowLeft className="w-5 h-5" />
            </Button>
          </Link>
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Chat Analysis</h1>
            <p className="text-muted-foreground mt-1 text-base">
              Deep-dive into <span className="text-primary font-semibold">{document.originalName}</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-6 h-[calc(100vh-16rem)] min-h-[600px]">
        <Card className="flex-1 flex flex-col border overflow-hidden shadow-sm relative">
        ...
        <Card className="w-80 hidden xl:flex flex-col flex-shrink-0 border shadow-sm">
